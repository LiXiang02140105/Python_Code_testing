...
def runnerTest():
    ...
    with open(logfile, "w+",encoding="utf-8") as fp:
        logRecord_pid = subprocess.Popen("D:/exe/adb.exe logcat",stdout=fp, shell=True)
        logCrash_pid = subprocess.call("D:/exe/python.exe ./tools/CrashLogs.py", shell=True) # 阻塞等待完成
        time.sleep(10)
